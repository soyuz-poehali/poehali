...
'<details class="dan_accordion">'.
	...
	'<table class="e_table_admin">'.
		'<tr>'.
			'<td class="e_td_right">Максимальная ширина блока</td>'.
			'<td>'.
		...
		'</tr>'.
		'<tr>'.
			'<td class="e_td_right">Максимальная ширина изображения 360°</td>'.
			'<td><input id="e_block_modal_max_width_360" class="dan_input" type="number" min="400", max="1000" value="'.$content['max_width_360'].'"><td>'.
		'</tr>'.
		'<tr>'.
