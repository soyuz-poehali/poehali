...
function block_slider($data)
{
	...
	$cpanel = 
		'<div class="e_block_panel">'.
			'<div class="e_block_panel_ico" data-action="slide_add" title="Добавить слайд"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/edit/blocks/template/e_sprite.svg#add"></use></svg></div>'.
			'<div class="e_block_panel_ico" data-action="slides" title="Слайды"><svg><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/edit/blocks/template/e_sprite.svg#images"></use></svg></div>'.
	...
	if ($data['content']['style'] == 1) {
		...
		$out =
		'<div id="block_'.$data['id'].'" class="block" '.$style_container.' data-type="block" data-block="slider" data-id="'.$data['id'].'">'.
			$cpanel.
