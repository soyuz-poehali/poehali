...
if ($content['phone_1']['pub'] == '1') {
	...
	if($phone_number[0] == 7) 
		$phone_number = '%2B'.$phone_number;

	$area_phone_1_phone = '<a href="tel:'.$phone_number.'" style="color:'.$content['phone_1']['color'].'">'.$content['phone_1']['phone'].'</a>';
	$area_phone_1_whatsapp = $content['phone_1']['whatsapp'] == 1 ? '<a href="whatsapp://send?phone='.$phone_number.'" title="WhatsApp"><svg class="svg_whatsapp"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/lib/svg/sprite.svg#whatsapp"></use></svg></a>' : '';
...
if ($content['phone_2']['pub'] == '1') {
	...
	$area_phone_2_phone = '<a href="tel:'.$phone_number.'" style="color:'.$content['phone_2']['color'].'">'.$content['phone_2']['phone'].'</a>';
	$area_phone_2_whatsapp = $content['phone_2']['whatsapp'] == 1 ? '<a href="whatsapp://send?phone='.$phone_number.'" title="WhatsApp"><svg class="svg_whatsapp"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/lib/svg/sprite.svg#whatsapp"></use></svg></a>' : '';
...
$out =
'<div id="block_'.$data['id'].'" class="block block_menu" data-block="menu" data-id="'.$data['id'].'">'.
	$cpanel.
