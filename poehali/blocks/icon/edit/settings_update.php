...
$content['wrap_bg_opacity'] = $_POST['wrap_bg_opacity'];
...
$content['title_size'] = intval($_POST['title_size']);
$content['icon_size'] = intval($_POST['icon_size']);
$content['icon_color'] = $_POST['icon_color'];
...
// Фон - изображение
$dir = $_SERVER['DOCUMENT_ROOT'].'/files/pages/'.$page_id.'/icon';
