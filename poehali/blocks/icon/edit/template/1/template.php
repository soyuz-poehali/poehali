...
$SITE->setHeadFile('/blocks/icon/frontend/1/BLOCK.icon_1.css');

function block_icon_1($data)
{
	global $SITE;
	...
	foreach ($content['icons'] as $icon) {
		...
		$cpanel_item =
			'<div class="e_item_panel">'.
				...
				'<div class="drag_drop_ico" title="Перетащить" data-id="'.$data['id'].'" data-target-id="block_icon_container_'.$data['id'].'" data-class="block_icon_item_1" data-f="EDIT.block.icon.update_ordering"><svg><use xlink:href="/edit/blocks/template/e_sprite.svg#cursor_24"></use></svg></div>'.
			...
			$icons .=
				'<div class="block_icon_item_1 e_block_item" '.$item_style.' data-block="icon" data-id="'.$data['id'].'" data-item-num="'.$i.'">'.
					$cpanel_item.
