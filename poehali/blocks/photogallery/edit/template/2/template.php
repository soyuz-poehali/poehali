	...
	foreach ($b['photos'] as $photo) {
		$cpanel_items =
			'<div class="e_item_panel">'.
				...
				'<div class="drag_drop_ico" title="Перетащить" data-id="'.$data['id'].'" data-target-id="block_photogallery_container_'.$data['id'].'" data-class="block_photogallery_photo_2_wrap" data-f="EDIT.block.photogallery.update_ordering"><svg><use xlink:href="/edit/blocks/template/e_sprite.svg#cursor_24"></use></svg></div>'.
