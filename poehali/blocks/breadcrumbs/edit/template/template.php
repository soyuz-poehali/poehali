...
$SITE->setHeadFile('/blocks/breadcrumbs/edit/template/EDIT.block.breadcrumbs.js');
...
function block_breadcrumbs($data)
{
	...
	return 
	'<div id="block_'.$data['id'].'" class="block" '.$style_container.' data-type="block" data-block="breadcrumbs" data-id="'.$data['id'].'">'.
