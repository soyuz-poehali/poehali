...
$SITE->content = 
	...
	'<div class="dan_flex_row help_overflow_unset ">'.
		'<div class="help_flex_50">'.
			'<div class="admin_content_help_titles_group">'.
				'<h2>Назначение текстового блока</h2>'.
			...
			'</div>'.
			'<div class="admin_content_help_titles_wrap">'.
				'<div class="admin_content_help_titles_group"><h2>Функции текстового блока</h2>'.
				'<div><ol>'.
				...
				'</div>'.
				'</div>'.	
				'<div class="admin_content_help_titles_group"><h2>Варианты отображения</h2>'.
				...
				'</div>'.
				'<div class="admin_content_help_titles_group"><h2>Настройки</h2>'.	
				...
				'<div class="admin_content_help_titles_group"><h2>Редактирование текста</h2>'.	
		...
		'<div class="help_flex_50 help_p20_40 dan_flex_row help_flex_right">'.		
			...
			'<img alt="" src="/blocks/text/frontend/help/images/1.webp" style="width:100%">'.
			//'<img style="width:100%;max-width: 525px;margin-top: 30px;" alt="" src="/blocks/text/frontend/help/images/2.webp" style="width:100%">'.
			//'<div><a href="/admin/help/ckeditor">CKEditir</a></div>'.
		'</div>'.
	'</div>';
